from mysql.connector import connect, pooling, Error, InterfaceError
import time

class Connection:

    _connection_pool = None
    _pool_initialized = None
    ...
    def __init__(self, 
        ...
        if not Connection._pool_initialized:
            Connection._initialize_pool(user, password, host, port, name)
